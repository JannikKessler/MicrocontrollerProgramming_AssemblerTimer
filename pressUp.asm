...
pressUp_delay:
	ldi cnt_low , byte1(counter/*pressUp_delayClk*/)
	ldi cnt_mid , byte2(counter/*pressUp_delayClk*/)
	ldi cnt_high , byte3(counter/*pressUp_delayClk*/)
	rcall delay1sec_start;delay_long
	rjmp pressUp_start
